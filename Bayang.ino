...
void Bayang_send_packet(u8 bind)
{
    ...
    if (bind) {
        ...
        packet[2] = GET_FLAG(FLIP_AUX, BAYANG_FLAG_FLIP)
                  | GET_FLAG(HEADLESS_AUX, BAYANG_FLAG_HEADLESS)
                  | GET_FLAG(RTH_AUX, BAYANG_FLAG_RTH)
                  | GET_FLAG(SHOT_AUX, BAYANG_FLAG_SNAPSHOT)
