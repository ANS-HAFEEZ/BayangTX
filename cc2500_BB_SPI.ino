...
/*
unsigned char cc2500_readFifo(unsigned char *data, unsigned char len)
{
  unsigned char reg_val;
  CS_off;                // CSN low, initialize SPI communication...
  SPI.transfer(CC2500_RXFIFO | CC2500_READ_BURST);    // Select register to read from..
  ...
  CS_on;                // CSN high, terminate SPI communication
...
{
    if(mode == TX_EN) {//from deviation formware
